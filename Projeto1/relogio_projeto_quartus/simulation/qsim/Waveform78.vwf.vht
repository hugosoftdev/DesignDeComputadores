...
-- *****************************************************************************
-- Generated on "10/03/2018 03:32:23"
...
COMPONENT relogio
	PORT (
	aluflagdebug : BUFFER STD_LOGIC;
	aluresultDebug : BUFFER STD_LOGIC_VECTOR(3 DOWNTO 0);
	...
	pcDebug : BUFFER STD_LOGIC_VECTOR(4 DOWNTO 0);
	r1debug : BUFFER STD_LOGIC_VECTOR(3 DOWNTO 0);
	regA : BUFFER STD_LOGIC_VECTOR(3 DOWNTO 0);
	regB : BUFFER STD_LOGIC_VECTOR(3 DOWNTO 0);
